        ...
        <div className="max-w-screen-lg mx-auto flex flex-col items-center h-full px-4 md:flex-row">
            <div className="flex flex-col justify-center h-full">
                ...
                <p  className="text-gray-500 py-4 max-w-md">
                    I have 8 years of experience building and devloping software. Currently, I like working with web applicitions using technolgies like React, Tailwind, Bootstrap.
                </p>
                <div>
